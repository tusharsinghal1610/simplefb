...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-5208161885165148",
...
if($_SESSION["check"] == 1)
{
echo "<div><b>Wrong Credentials<b/></div>";
}
}
?>
...
<a href="createaccount.php" ><div class="button">create account<sub>(one step)</sub></div></a>
<br>
<div>
